...
class Store extends conf_1.default {
    ...
    setupListeners() {
        ...
        electron_1.ipcMain.handle(this.messageHelper.GET, messaging_1.wrapMessageHandler(this.handleGet));
        electron_1.ipcMain.handle(this.messageHelper.SET, messaging_1.wrapMessageHandler(this.handleSet));
        electron_1.ipcMain.handle(this.messageHelper.DELETE, messaging_1.wrapMessageHandler(this.handleDelete));
        electron_1.ipcMain.handle(this.messageHelper.DESTORY_STORE, messaging_1.wrapMessageHandler(this.handleDestoryStore));
        this.listening = true;
    }
    handleGet(event, key) {
